...
def upgrade() -> None:
    ...
    sa.Column('id', app.database_types.GUID(), nullable=False),
    sa.Column('user_id', app.database_types.GUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('status', sa.String(), nullable=False),
    sa.Column('settings_snapshot', app.database_types.JSON(), nullable=True),
    ...
    sa.Column('id', app.database_types.GUID(), nullable=False),
    sa.Column('run_id', app.database_types.GUID(), nullable=False),
    ...
    sa.Column('id', app.database_types.GUID(), nullable=False),
    sa.Column('task_id', app.database_types.GUID(), nullable=False),
    sa.Column('user_id', app.database_types.GUID(), nullable=False),
